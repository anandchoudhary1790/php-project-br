    ...
    <div class="col-md-12 mx-auto">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="pace-right">
                            ...
                            <p> <i class="fa fa-calendar"></i> <?php echo date('d M Y',strtotime($slot->date)); ?> <span class="pull-right hide"> <strong><i class="fa fa-rupee"></i> <?=$slot->fees?>/-</strong></span></p>
        ...
        <div class="workingpart">
            ...
            <div class="form-group">
                ...
                <div class="pull-right"> <a href="#" data-toggle="modal" data-target="#myModal"> 0.8 km <i class="fa fa-location-arrow"></i> </a> </div>
            </div>
        ...
        <div class="btdetialpart">
            ...
            <div class="pull-right"><strong><i class="fa fa-rupee"></i> 50/-</strong> </div>
        </div>
