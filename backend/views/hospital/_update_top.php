...
<div class="row" style="margin-bottom:10px;">
    ...
    <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" class="btn btn-block btn-warning" onclick="location.href='<?php echo yii\helpers\Url::to(['hospital/my-doctors?id='.$userProfile->user_id]); ?>';">My Doctors</button>
    </div>
       <div class="col-md-2 col-sm-6 col-xs-12">
