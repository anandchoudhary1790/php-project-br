...
/**
 * DetailView displays the details of a single data [[model]].
 *
...
class DetailView extends Widget
{
    ...
    public $model;
    /**
     * @var array a list of attributes to be displayed in the details view. Each array element
     ...
     */
    public $options = ['class' => 'table table-striped table-bordered details-view'];
    /**
     ...
     * This is the main entry of the whole details view rendering.
     */
    public function run()
    {
        $rows = [];
